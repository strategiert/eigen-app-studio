...
export function DynamicWorldHeader({
  ...
  // Get AI-generated atmosphere from worldConcept, or mood/era if actually set by AI (not fallbacks)
  const mood = worldDesign?.visualIdentity?.mood;
  const era = worldDesign?.visualIdentity?.era;
  const atmosphere = worldDesign?.worldConcept?.atmosphere;

  // Only show mood/era if they were actually generated by AI (exist in the design)
  // Otherwise show atmosphere, or nothing
  const displayText = atmosphere || (mood && era ? `${mood} · ${era}` : null);
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              {/* Show atmosphere from AI-generated design (not fallback values) */}
              {displayText && (
                <motion.div
