...
const steps = [
  {
    ...
    description: "Lade deine Klassenarbeit, Arbeitsblätter oder Lernmaterialien hoch - als Text oder PDF.",
  },
  {
    number: "02",
    icon: Sparkles,
    title: "KI generiert",
    description: "Die KI analysiert dein Material und erstellt eine interaktive Lernwelt mit Quiz und Übungen.",
  },
  {
    number: "03",
    icon: Share,
    title: "Anpassen & Teilen",
    description: "Passe die generierte Welt nach deinen Wünschen an und teile sie mit deinen Schülern.",
  },
  {
    number: "04",
    icon: Rocket,
    title: "Lernen & Spaß",
    description: "Deine Schüler erkunden die Lernwelt, sammeln Sterne und festigen ihr Wissen spielerisch.",
  },
];
