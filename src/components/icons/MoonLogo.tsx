...
export const MoonLogo = ({ className, size = "md", animate = true }: MoonLogoProps) => {
  return (
    <div
      className={cn(
        "relative",
    ...
    >
      ...
      <div className="absolute top-2 -left-2 w-1.5 h-1.5 rounded-full bg-stars animate-twinkle" style={{ animationDelay: "0.5s" }} />
      <div className="absolute -bottom-1 right-3 w-1 h-1 rounded-full bg-stars animate-twinkle" style={{ animationDelay: "1s" }} />
    </div>
  );
};
