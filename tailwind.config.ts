  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          from: { boxShadow: "0 0 20px hsl(var(--moon) / 0.3)" },
          to: { boxShadow: "0 0 40px hsl(var(--moon) / 0.6)" },
        },
        "fade-in": {
      ...
      backgroundImage: {
        ...
        shimmer: "linear-gradient(90deg, transparent 0%, hsl(var(--moon) / 0.1) 50%, transparent 100%)",
      },
    },
  },
